...
import { Mail, AlertCircle, ArrowLeft, ArrowRight, Sparkles, Lock } from 'lucide-react';
    ...
    return (
      <div className="flex min-h-screen items-center justify-center bg-background">
        <div className="relative flex flex-col items-center justify-center gap-4">
          ...
          <span className="text-xs font-semibold text-muted-foreground animate-pulse">Checking credentials...</span>
        </div>
      </div>
    );
  }
      ...
      <div className="w-full max-w-md z-10">
        <Card className="border-border bg-card/40 backdrop-blur-xl shadow-2xl hover:border-border/80 transition-all duration-300">
          <CardHeader className="text-center pt-8 pb-4">
            <div className="mx-auto h-10 w-10 rounded-xl bg-gradient-to-tr from-primary to-violet-500 flex items-center justify-center font-bold text-white shadow-md shadow-primary/20 mb-4 select-none">
              C
            </div>
            ...
            <CardDescription className="text-sm">
              Log in to your Chatify account
            </CardDescription>
          </CardHeader>
          ...
          <CardContent className="pb-4">
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <Button type="submit" loading={isSubmitting} className="w-full h-11 text-sm font-semibold">
